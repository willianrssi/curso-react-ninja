...
it('reverse(["Willian", "Rodrigues", "da Silva"]) should return ["da Silva", "Rodrigues", "Willian"]', () => {
  expect(reverse(['Willian', 'Rodrigues', 'da Silva'])).to.be.deep.equal(['da Silva', 'Rodrigues', 'Willian'])
})
